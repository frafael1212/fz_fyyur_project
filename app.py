...
def create_venue_submission():
  ...
  vgenres = request.form.get('genres')
  vfblink = request.form.get('facebook_link')
  try:
    #instantiate venue
    new_venue = Venue(name=vname,city=vcity,state=vstate,address=vaddress,phone=vphone,genres=vgenres,facebook_link=vfblink)
    #add to db
...
def create_artist_submission():
  ...
  agenres = request.form.get('genres')
  afblink = request.form.get('facebook_link')
  try:
    #instantiate venue
    new_artist= Artist(name=aname,city=acity,state=astate,phone=aphone,genres=agenres,facebook_link=afblink)
    #add to db
...
def create_show_submission():
  ...
  try:
    #instantiate show
    new_show = Show(start_time=starttime,artist_id=artistid,venue_id=venueid)
    #add to db
